      ...
      if (data.object === 'page') {
        ...
        processor.getResponse(data)
          .then(response=>{
            ...
            payload.recipient = {id:data.entry[0].messaging[0].sender.id};
            //console.log(payload);
...
function callSendAPI(messageData) {
  ...
  request({
    ...
    qs: { access_token: "EAAIZBZASCkVw0BACZAzBqVfz6VKMWfuLuaOZBTZCU7SYFGTm8VTaFbD1Lla23kXHuEZCfAPszurAzWyKPdqZB28J8mwGrWRm5qZB6xix2Qveb9rsdzOEhst5bQ2QJELAww7kG2ZB7TJsXfCLorNcWyx7gdIzJXTQgZB10XrGXoFMW5vQZDZD" },
    method: 'POST',
    json: messageData
